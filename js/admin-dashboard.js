...
/**
 * Carga las estadÃ­sticas generales - INTEGRADO
 */
async function loadEstadisticas() {
    try {
        ...
        try {
            ...
            console.warn('No se pudo cargar estadÃ­stica de cursos:', error);
    ...
    return `
        <div class="config-card ${isActive ? 'active' : 'inactive'}">
            ...
            <div class="config-details">
                ...
                <div class="config-detail-item">
                    <span class="config-detail-label">MatrÃ­cula</span>
    ...
    return `
        <div class="card">
            <div class="card-body">
                ...
                <p>${safeExcerpt(noticia.resumen || noticia.contenido, 150)}</p>
                <div class="action-buttons mt-md">
...
function abrirModalNuevaNoticia() {
    window.location.href = './noticias/editor.html';
}

function editarNoticia(noticiaId) {
    window.location.href = './noticias/editor.html?id=' + encodeURIComponent(noticiaId);
}
...
async function handleNoticiaSubmit(e) {
    ...
    if (!titulo || !contenido) {
        Utils.showError('TÃ­tulo y contenido son obligatorios');
        return;
    }
